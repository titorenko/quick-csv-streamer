...
import com.elementarysoftware.quickcsv.api.StandardMappers;
...
public class CorrectnessTest {
    ...
    public void testParse() throws IOException {
        ...
        assertArrayEquals(new String[] {"1996", "Jeep", "Grand Cherokee", "MUST SELL!\nair, moon roof, loaded", "4799.00"}, rows[3].toArray(new String[0]));
